...
namespace LoginApi.Infrastructure.Identity
{
    public static class ServiceRegistration
    {
        public static IServiceCollection AddIdentityInfrastructure(this IServiceCollection services, IConfiguration configuration, bool UseInMemoryDatabase)
        {
            ...
            {
                services.AddDbContext<IdentityContext>(options =>
                    options.UseNpgsql(configuration.GetConnectionString("IdentityConnection")), ServiceLifetime.Scoped);

            }

            services.AddTransient<IGetUserServices, GetUserServices>();
            services.AddTransient<IAccountServices, AccountServices>();
            services.AddTransient<ICurrencyBoardAuthService, CurrencyBoardAuthService>();
            services.AddTransient<IBranchServices, BranchServices>();
            services.AddTransient<IDomainRepository, DomainService>();

            services.AddTransient<ITenantService, TenantService>();
            services.AddAutoMapper(AppDomain.CurrentDomain.GetAssemblies());
            services.AddTransient<IRoleService, RoleService>();
            services.AddTransient<IFunctionalMasterService, FunctionalMasterService>();
            services.AddTransient<IUserService, UserService>();
            services.AddTransient<IFeatureService, FeatureService>();
            services.AddTransient<IFeedbackService, FeedbackService>();
            services.AddTransient<IVerticalServices, VerticalServices>();

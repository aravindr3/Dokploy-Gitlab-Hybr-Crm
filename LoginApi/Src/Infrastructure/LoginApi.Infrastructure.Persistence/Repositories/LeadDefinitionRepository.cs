...
{
    public class LeadDefinitionRepository : GenericRepository<LeadProperyDefinition>, IleadPropertyDefinitionServices
    {
        public LeadDefinitionRepository(ApplicationDbContext dbContext)
            : base(dbContext)
        {
        }

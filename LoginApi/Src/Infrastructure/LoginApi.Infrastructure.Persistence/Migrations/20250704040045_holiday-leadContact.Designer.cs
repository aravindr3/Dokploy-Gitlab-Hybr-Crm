...
namespace HyBrForex.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20250704040045_holiday-leadContact")]
    partial class holidayleadContact
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("HyBrCRM.Domain.Exchange.Entities.Lead", b =>
                {
                    ...
                    b.HasOne("HyBrCRM.Domain.Exchange.Entities.Stages", "LeadStatus")
                        .WithMany()
            ...
            modelBuilder.Entity("HyBrCRM.Domain.Exchange.Entities.TaskMaster", b =>
                {
                    ...
                    b.HasOne("HyBrCRM.Domain.Exchange.Entities.Lead", "Lead")
                        .WithMany()

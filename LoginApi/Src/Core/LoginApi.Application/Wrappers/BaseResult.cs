...
public class BaseResult<TData> : BaseResult
{
    ...
    public new static BaseResult<TData> Failure(TData error)
    {
        return new BaseResult<TData> { Success = false };
    }
    public new static BaseResult<TData> Failure(TData error, Error _error)
    {
        return new BaseResult<TData> { Success = false,Data = error ,Errors = [_error] };
    }
